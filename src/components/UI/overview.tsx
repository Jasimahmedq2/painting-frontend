...
const OverView = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="grid grid-cols-2 gap-x-2 row-gap-8 md:grid-cols-3">
        <div
          data-aos="fade-up"
          data-aos-offset="200"
          data-aos-delay="50"
        ...
        >
          ...
          <p className="text-gray-700 pt-3">
            ...
            we have finished. Discover the difference with our top-notch painting
            services.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className="font-bold">Pending Services:</p>
          <p className="text-gray-700 pt-3">
