...
const ProfilePage = () => {
  ...
  return (
    <>
      ...
      />
      {isLoading || PIsLoading || CIsLoading || CLIsLoading ? (
        <Skeleton className="flex justify-center items-center h-screen w-1/2 mx-auto" />
      ) : (
        <div className=" flex justify-center items-center  flex-col md:flex-row  sm:my-20 sm:mx-20 p-6 sm:p-16 bg-white shadow">
          ...
          <div className="space-y-12 max-w-[350px] rounded-tr-lg rounded-br-lg md:w-[350px] text-center p-10 shadow-[0px_7px_30px_2px_rgba(100,100,111,0.2)]">
            ...
            data?.data?.role === "painter" ? (
              ...
              <div className="space-y-1">
                <p className="text-gray-500 text-lg font-sans">profile</p>
                <p className="text-3xl tracking-wider text-gray-700">Admin</p>
              </div>
            )}
            <div>
